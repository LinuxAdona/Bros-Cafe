                ...
                <div class="grid grid-cols-1 gap-8 mb-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-4">
                            <a href="#" class="text-gray-400 transition-colors hover:text-amber-500">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-gray-400">
                            <li class="flex items-start">
                                <svg class="w-6 h-6 mr-2 shrink-0 text-amber-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <!-- Contact Info -->
                    <div>
                        <h3 class="mb-4 text-xl font-bold text-amber-500">Contact Us</h3>
                        <ul class="space-y-3 text-gray-400">
